...
int main() {
    ...
    assert(
        status_code("511 Network Authentication Required") == StatusCode::server_error_network_authentication_required);
    assert(
        status_code(StatusCode::server_error_network_authentication_required) == "511 Network Authentication Required");
}
