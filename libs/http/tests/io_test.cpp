...
int main() {
    ...
    // Test asynchronous requests
    {
        ...
        client.request("GET",
                       "/match/123",
                       [&call](shared_ptr<HttpClient::Response> response, const SimpleWeb::error_code &ec) {
                         assert(!ec);
                         stringstream output;
    ...
    // Test server destructor
    {
        ...
        bool client_catch = false;
        {
            ...
            server.resource["^/test$"]["GET"] =
                [&call](shared_ptr<HttpServer::Response> response, shared_ptr<HttpServer::Request> /*request*/) {
                  call = true;
