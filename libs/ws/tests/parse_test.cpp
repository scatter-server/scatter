...
class SocketServerTest : public SocketServerBase<WS> {
 public:
    ...
    void parse_request_test() {
        ...
        assert(RequestMessage::parse(stream,
                                     connection->method,
                                     connection->path,
...
class SocketClientTest : public SocketClientBase<WS> {
 public:
    SocketClientTest(const std::string &server_port_path) : SocketClientBase<WS>::SocketClientBase(server_port_path,
                                                                                                   80) { }
    ...
    void parse_response_header_test() {
        ...
        assert(ResponseMessage::parse(*connection->message,
                                      connection->http_version,
