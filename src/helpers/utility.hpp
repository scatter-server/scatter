...
class RegexOrderable : public regexns::regex {
    std::string str;

 public:
    RegexOrderable(const char *regex_cstr) : regexns::regex(regex_cstr), str(regex_cstr) { }
    RegexOrderable(const std::string &regex_str) : regexns::regex(regex_str), str(regex_str) { }
