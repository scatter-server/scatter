...
#ifndef SCATTER_SERVER_SCATTERBOOSTTCPHANDLER_H
#define SCATTER_SERVER_SCATTERBOOSTTCPHANDLER_H
 ...
 */
class ScatterBoostAsioHandler : public virtual AMQP::TcpHandler {
 protected:
 ...
 public:
     ...
     *  @param  that    The object to not move or copy
     */
    ScatterBoostAsioHandler() = delete;

    /**
     *  Constructor
     *  @param  io_service    The boost io_service to wrap
     */
    explicit ScatterBoostAsioHandler(boost::asio::io_service &io_service) :
        _ioservice(io_service),
     ...
     *  @param  that    The object to not move or copy
     */
    ScatterBoostAsioHandler(ScatterBoostAsioHandler &&that) = delete;
    ScatterBoostAsioHandler(const ScatterBoostAsioHandler &that) = delete;
...
#endif //SCATTER_SERVER_SCATTERBOOSTTCPHANDLER_H
